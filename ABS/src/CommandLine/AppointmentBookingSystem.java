...
public class AppointmentBookingSystem {
	                        ...
	                        do
	                        {
	                            ...
	                            switch(choice1)
	                            {
	                                ...
	                                case 4:
	                                {
	                                    ...
	                                    owner.addServices(serviceName);
	                                    break;
	                                }
	                                case 5:
	                                {
	                                	System.out.println("Select service to delete");
	                                	ArrayList<String>serviceList = owner.getServices();
	                                	Scanner in2 = new Scanner(System.in);
	                                    choice = in2.nextInt();
	                                    String serviceName = serviceList.get(choice - 1);
	                    ...
	                    {		
	                        ...
	                        do
	                        {
	                            ...
	                            switch(choice2)
	                            {
	                                case 1:
	                                {
	                                	customer.showBookingTimeTable(data2);
	                                    break;
	                                }
	//                                case 2:
	//                                {
    ...
    public void whileLoggedIns() {
    	try{
    	CustomerPanel customer = new CustomerPanel();
        String input = Utils.validateIntegerInput("\nSelect Activity\n1. Show Booking Time Slots\n2. Book Custom Appointment\n3. Cancel Booking\n4. Terminate\n", 1, 4);
        int choice2 = Integer.parseInt(input);
